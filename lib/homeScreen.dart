  ...
  Widget build(BuildContext context) {
    ...
    return WillPopScope(
      ...
      child: Scaffold(appBar: AppBar(
        backgroundColor: Color.fromARGB(255, 229, 182, 13),
        title:Center(child: Text('تطبيق المعلم الخصوصي')),
        
       
        actions: [
          IconButton(icon: Icon(Icons.person,color: Color.fromARGB(255, 68, 231, 78),),
          onPressed: (){
